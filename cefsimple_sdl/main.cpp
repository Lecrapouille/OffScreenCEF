                ...
                case SDL_KEYDOWN:
                    {
                        ...
                        // From CEF doc (cef/include/internal/cef_types.h):
                        // windows_key_code: DOM specification.
                        // character: generated by the keystroke.
                        // native_key_code: key code genenerated by the platform.
                        // unmodified_character: Same as 'character' but unmodified
                        // by any concurrently-held modifiers (except shift). This
                        // is useful for working out shortcut keys.
                        event.windows_key_code = getWindowsKeyCode(e.key.keysym);
                        event.unmodified_character = e.key.keysym.sym;
                        //event.native_key_code = e.key.keysym.sym;
                        event.character = e.key.keysym.sym;

                        // From CEF doc (cef/include/internal/cef_types.h):
                        // KEYEVENT_RAWKEYDOWN: falling edge key up => key down
